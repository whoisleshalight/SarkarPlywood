(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-home__slider")) new core(".main-home__slider", {
            modules: [ Navigation, Pagination, Parallax, EffectFade, Scrollbar, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            spaceBetween: 0,
            ...
            pagination: {
                ...
                renderCustom: function(swiper, current, total) {
                    let totalEl = document.querySelector(".nav-bottom-main-home__total");
                    totalEl.innerHTML = `0${total}`;
                    let curEl = document.querySelector(".nav-bottom-main-home__current");
                    curEl.innerHTML = `0${current}`;
                }
            },
            scrollbar: {
                el: ".main-home-scrollbar",
                draggable: true
            },
            navigation: {
                prevEl: ".main-home-button-prev",
                nextEl: ".main-home-button-next"
            }
        });
        if (document.querySelector(".cart-slider")) new core(".cart-slider", {
            ...
            watchSlidesProgress: true,
            navigation: {
                prevEl: ".slide-cart-block-prev",
                nextEl: ".slide-cart-block-next"
            }
        });
    }
...
*/    var getOwnPropertySymbols = Object.getOwnPropertySymbols;
    ...
    if (document.querySelector(".floring__video")) {
        let playBtn = document.querySelector(".floring__video");
    ...
    window.addEventListener("load", (function() {
        ...
        setTimeout((() => {
            const scroll = new locomotive_scroll_esm({
                el: document.querySelector("[data-scroll-container]"),
                smooth: true
            });
            if (document.querySelector(".prd-b")) {
                document.querySelector(".products");
                const productsBody = document.querySelector(".products__body");
                scroll.on("scroll", (() => {
                    const productsBodyRect = productsBody.getBoundingClientRect();
                    const trigger = window.innerHeight - 200;
                    if (productsBodyRect.top < trigger && productsBodyRect.bottom > 0) productsBody.classList.add("background"); else productsBody.classList.remove("background");
                }));
            }
            scroll.on("scroll", (function(obj) {
                const header = document.querySelector(".header");
                if (obj.scroll.y > 300) header.classList.add("_header-scroll"); else header.classList.remove("_header-scroll");
            }));
        }), 1200);
    }));
    window["FLS"] = true;
